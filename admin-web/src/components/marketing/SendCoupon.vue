        ...
        <el-card shadow="always">
          <el-row :gutter="12">
            ...
            <el-col :offset='3' :span="1">
              <el-button @click="handleSearchUser" type="primary">查询</el-button>
            </el-col>
          </el-row>
        </el-card>
      </el-col>
      ...
      <el-col :span="24">
        <el-table
          ...
          <el-table-column
            ...
            label="操作">
            <template slot-scope="scope">
              <el-button type="primary" plain size="small" @click="handleSend(scope.$index,scope.row)">赠送优惠券</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-col>
...
<script>
    ...
    import {sendUserCoupon} from '@/api/marketing'
    export default {
        created () {
        ...
        methods: {
            ...
            handleSend(index,row){
                let params="userId="+row.id+"&userName="+row.userName+"&couponCode="+this.$route.query.couponCode
                console.log(params)
                sendUserCoupon(params).then(res=>{
                    if (res.code === 0) {
